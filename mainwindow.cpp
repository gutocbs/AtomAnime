...
MainWindow::MainWindow(QWidget *parent)
  ...
  //    connect(cfiledownloader,&filedownloader::sidGrande,this,&MainWindow::fsetIdBaixadoGrande,
  //    Qt::QueuedConnection);
...
void MainWindow::fcarregouListaSucesso(bool ldownload) {
  ...
  // Começa a crescer depois desse ponto. E passa aqui uma segunda vez com um
  // único refresh? Descobrir por que passa a segunda vez
...
void MainWindow::fsetIdAdicionado(QString lid) {
...
void MainWindow::fsetIdBaixado(QString lid) { vimagemBaixada[lid] = true; }

void MainWindow::fsetIdBaixadoGrande(QString lid) {
  vimagemBaixadaGrande[lid] = true;
}

void MainWindow::fInfoAnimeTorrent(QString lnomeAnime) {
...
void MainWindow::fcarregaImagensLista() {
  ...
  if (!vlistaSelecionada.isEmpty()) {
    ...
    if (vlistaSelecionada[0 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime00Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    else if (vlistaSelecionada[0 + (12 * (vpagina - 1))]->vnome.size() < 58)
      ui->labelAnime00Titulo->setStyleSheet(
          "background: transparent; font: 75 7pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    else
      ui->labelAnime00Titulo->setStyleSheet(
          "background: transparent; font: 75 6pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime00Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime00Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
  ...
  if (vlistaSelecionada.size() > 1 + (12 * (vpagina - 1))) {
    ...
    if (vlistaSelecionada[1 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime01Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime01Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime01Progresso->setStyleSheet(
  ...
  if (vlistaSelecionada.size() > 2 + (12 * (vpagina - 1))) {
    ...
    if (vlistaSelecionada[2 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime02Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime02Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime02Progresso->setStyleSheet(
  ...
  if (vlistaSelecionada.size() > 3 + (12 * (vpagina - 1))) {
    ...
    if (vlistaSelecionada[3 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime03Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime03Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime03Progresso->setStyleSheet(
  ...
  if (vlistaSelecionada.size() > 4 + (12 * (vpagina - 1))) {
    ...
    if (vlistaSelecionada[4 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime04Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime04Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime04Progresso->setStyleSheet(
  ...
  if (vlistaSelecionada.size() > 5 + (12 * (vpagina - 1))) {
    ...
    if (vlistaSelecionada[5 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime05Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime05Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime05Progresso->setStyleSheet(
  ...
  if (vlistaSelecionada.size() > 6 + (12 * (vpagina - 1))) {
    ...
    if (vlistaSelecionada[6 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime06Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime06Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime06Progresso->setStyleSheet(
  ...
  if (vlistaSelecionada.size() > 7 + (12 * (vpagina - 1))) {
    ...
    if (vlistaSelecionada[7 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime07Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime07Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime07Progresso->setStyleSheet(
  ...
  if (vlistaSelecionada.size() > 8 + (12 * (vpagina - 1))) {
    ...
    if (vlistaSelecionada[8 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime08Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime08Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime08Progresso->setStyleSheet(
  ...
  if (vlistaSelecionada.size() > 9 + (12 * (vpagina - 1))) {
    ...
    if (vlistaSelecionada[9 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime09Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime09Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime09Progresso->setStyleSheet(
  ...
  if (vlistaSelecionada.size() > 10 + (12 * (vpagina - 1))) {
    ...
    if (vlistaSelecionada[10 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime10Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime10Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime10Progresso->setStyleSheet(
  ...
  if (vlistaSelecionada.size() > 11 + (12 * (vpagina - 1))) {
    ...
    if (vlistaSelecionada[11 + (12 * (vpagina - 1))]->vnome.size() < 47)
      ui->labelAnime11Titulo->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(20, 20, 20);");
    ...
    if (!carquivos
             ...
             .isEmpty())
      ui->labelAnime11Progresso->setStyleSheet(
          "background: transparent; font: 75 8pt \"Calibri\"; font-weight: "
          "bold; color: rgb(53, 120, 56);");
    else
      ui->labelAnime11Progresso->setStyleSheet(
...
// Eu sei, tá bem feio, mas é como funcionou. Provavelmente eu poderia fazer uma
// função pro que tem dentro do for. Provavelmente eu deveria.
  ...
  for (int i = 0; i < 3; i++) {
    if (vdownloadImagensPequenas) {
      ...
      for (int j = 0; j < 15; j++) {
        ...
        switch (j) {
        case 0:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "watching");
          break;
        case 1:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "completed");
          break;
        case 2:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "onhold");
          break;
        case 3:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "dropped");
          break;
        case 4:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "plantowatch");
          break;
        case 5:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "mangareading");
          break;
        case 6:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "mangacompleted");
          break;
        case 7:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "mangaonhold");
          break;
        case 8:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "mangadropped");
          break;
        case 9:
          vcarregaListaBackground =
        ...
        case 10:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "novelreading");
          break;
        case 11:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "novelcompleted");
          break;
        case 12:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "novelonhold");
          break;
        case 13:
          vcarregaListaBackground =
              cleitorListaAnimes->sortLista(vordem, "noveldropped");
          break;
        case 14:
          vcarregaListaBackground =
        ...
        if (!vcarregaListaBackground.isEmpty()) {
          for (int i = 0; i < vcarregaListaBackground.size(); i++) {
            if (vrefreshAcontecendo == true)
              return false;
            // Testa pra ver se a imagem já foi baixada por completo, pra evitar
            // que a imagem fique corrompida
            //                    qDebug() << "Carregou pequeno " <<
            //                    vcarregaListaBackground[i]->vlista << i;
            if (vimagemCarregada[vcarregaListaBackground[i]->vid] == false &&
                vimagemBaixada[vcarregaListaBackground[i]->vid] == true) {
              if (QFile::exists(file + vcarregaListaBackground[i]->vid +
                                ".jpg")) {
                if (lpix.load(file + vcarregaListaBackground[i]->vid + ".jpg",
                              "jpg", Qt::ColorOnly)) {
                  ui->labelImagemBackground->setPixmap(lpix);
                  vimagemCarregada[vcarregaListaBackground[i]->vid] = true;
                }
              } else if (QFile::exists(file + vcarregaListaBackground[i]->vid +
                                       ".png")) {
                if (lpix.load(file + vcarregaListaBackground[i]->vid + ".png",
                              "png", Qt::ColorOnly)) {
                  ui->labelImagemBackground->setPixmap(lpix);
                  vimagemCarregada[vcarregaListaBackground[i]->vid] = true;
                }
            ...
            if (vimagemCarregada[vcarregaListaBackground[i]->vid] == false &&
              ...
              if (QFile::exists(file + vcarregaListaBackground[i]->vid +
                ...
                if (lpix.load(file + vcarregaListaBackground[i]->vid + ".jpg",
                              "jpg", Qt::ColorOnly)) {
                  ui->labelImagemBackground->setPixmap(lpix);
                  vimagemCarregada[vcarregaListaBackground[i]->vid] =
                      true; // Erro no qmap
                }
              } else if (QFile::exists(file + vcarregaListaBackground[i]->vid +
                                       ".png")) {
      ...
      for (int j = 0; j < 15; j++) {
        ...
        if (!vcarregaListaBackground.isEmpty()) {
          for (int i = 0; i < vcarregaListaBackground.size(); i++) {
            ...
            // Testa pra ver se a imagem já foi baixada por completo, pra evitar
            // que a imagem fique corrompida
            //                    qDebug() << "Carregou grande " <<
            //                    vcarregaListaBackground[i]->vlista << i;
            if (vimagemCarregadaGrande[vcarregaListaBackground[i]->vid] ==
                    false &&
                vimagemBaixadaGrande[vcarregaListaBackground[i]->vid] == true) {
              if (QFile::exists(file + vcarregaListaBackground[i]->vid +
                                ".jpg")) {
                if (lpixGrande.load(file + vcarregaListaBackground[i]->vid +
                                        ".jpg",
                                    "jpg", Qt::ColorOnly)) {
                  ui->labelImagemBackgroundGrande->setPixmap(lpixGrande);
                  vimagemCarregadaGrande[vcarregaListaBackground[i]->vid] =
                      true;
                }
              } else if (QFile::exists(file + vcarregaListaBackground[i]->vid +
                                       ".png")) {
  ...
  if (ui->janelaRotativa->currentIndex() == 0) {
    if (!ui->barraBusca->toPlainText().isEmpty()) {
      ...
      vlistaSelecionada = cleitorListaAnimes->fbuscaLista(
          ui->barraBusca->toPlainText(), vtipoAtual);
      if (!vlistaSelecionada.isEmpty()) {
        vlistaAtual = "busca";
        vanimeSelecionado = 0;
        vpagina = 1;
...
void MainWindow::on_botaoRemoverdaLista_clicked() {
  ...
  cleitorListaAnimes->fdeletedaLista(
...
// Eu sei que seria muito melhor usar qml pra fazer isso. Seria 10x mais fácil e
// mais prático de programar. Mas ainda não aprendi QML e estou para aprender num
// futuro próximo. Assim que começar a aprender, isso vai sumir e iriei mudar o
// visual do programa
void MainWindow::fmudaResolucao() {
  ...
  foreach (QObject *wid, objectList) {
    ...
    double a = static_cast<double>(
                   this->findChild<QWidget *>(wid->objectName())->pos().rx()) /
               1920;
  ...
  //        double a = static_cast<double>(this->findChild<QWidget
  //        *>(wid->objectName())->pos().rx())/1920; double b =
  //        static_cast<double>(this->findChild<QWidget
  //        *>(wid->objectName())->pos().ry())/821; double compHeight =
  //        static_cast<double>(widheight)/821; double compWidth =
  //        static_cast<double>(width)/1920; double objWid =
  //        static_cast<double>(this->findChild<QWidget
  //        *>(wid->objectName())->width()); double objHei =
  //        static_cast<double>(this->findChild<QWidget
  //        *>(wid->objectName())->height()); qDebug() << wid->objectName() <<
  //        this->findChild<QWidget *>(wid->objectName())->pos().rx()
  //                 << this->findChild<QWidget
  //                 *>(wid->objectName())->pos().ry()
  //                 << a*width << b*widheight;
  //        this->findChild<QWidget
  //        *>(wid->objectName())->resize(qCeil(static_cast<int>(compWidth*objWid)),
  //                                                              qCeil(static_cast<int>(compHeight*objHei)));
  //        this->findChild<QWidget
  //        *>(wid->objectName())->move(qCeil(static_cast<int>(a*width)),
  //        qCeil(static_cast<int>(b*widheight)));
  ...
  foreach (QObject *wid, widgetList) {
    ...
    if (this->findChild<QWidget *>(wid->objectName())
            ->objectName()
            .contains("botaoAnime", Qt::CaseInsensitive) ||
        (this->findChild<QWidget *>(wid->objectName())
             ->objectName()
             .contains("imagemAnime", Qt::CaseInsensitive) &&
         !this->findChild<QWidget *>(wid->objectName())
              ->objectName()
              .contains("grande", Qt::CaseInsensitive))) {
      this->findChild<QWidget *>(wid->objectName())
      ...
      if (this->findChild<QWidget *>(wid->objectName())
              ->objectName()
              .contains("botaoAnime", Qt::CaseInsensitive))
        vposicaoGrade = this->findChild<QWidget *>(wid->objectName())
                            ->objectName()
                            .remove("botaoAnime");
      else if (this->findChild<QWidget *>(wid->objectName())
                   ->objectName()
                   .contains("imagemAnime", Qt::CaseInsensitive))
        vposicaoGrade = this->findChild<QWidget *>(wid->objectName())
                            ->objectName()
    ...
    // Labelfundo e label anime são separados por motivos de tamanho do label
                 ...
                 ->objectName()
                 .contains("labelFundoAnime", Qt::CaseInsensitive)) {
      if (this->findChild<QWidget *>(wid->objectName())
              ->objectName()
              .contains("titulo", Qt::CaseInsensitive))
        this->findChild<QWidget *>(wid->objectName())
            ->resize(ui->labelFundoAnime00Titulo->width(),
      ...
      if (this->findChild<QWidget *>(wid->objectName())
        ...
        ypos =
            static_cast<int>(ui->labelFundoAnime00Titulo->y() +
                     ...
                     ->objectName()
                     .contains("lista", Qt::CaseInsensitive)) {
    ...
    // Agora começa a mudar os textos
                 ...
                 ->objectName()
                 .contains("labelAnime", Qt::CaseInsensitive)) {
      if (this->findChild<QWidget *>(wid->objectName())
              ->objectName()
              .contains("titulo", Qt::CaseInsensitive))
        this->findChild<QWidget *>(wid->objectName())
            ->resize(ui->labelAnime00Titulo->width(),
    ...
    //        Qt::CaseInsensitive)){
                  ...
                  ->objectName()
                  .contains("imagemanimegrande", Qt::CaseInsensitive)) {
      ...
      this->findChild<QWidget *>(wid->objectName())
          ->move(static_cast<int>(
                     (static_cast<double>(
                          this->findChild<QWidget *>(wid->objectName())->x()) /
                      1920) *
                     width),
                 static_cast<int>(
                     (static_cast<double>(
                          this->findChild<QWidget *>(wid->objectName())->y()) /
                      821) *
                     widheight));
      //            int ypos = 0;
      //            if(this->findChild<QWidget
      //            *>(wid->objectName())->objectName().contains("titulo",
      //            Qt::CaseInsensitive)){
      //                vposicaoGrade = vposicaoGrade.remove("titulo",
      //                Qt::CaseInsensitive); ypos =
      //                ui->labelAnime00Titulo->y();
      //            }
      //            else if(this->findChild<QWidget
      //            *>(wid->objectName())->objectName().contains("progresso",
      //            Qt::CaseInsensitive)){
      //                vposicaoGrade = vposicaoGrade.remove("progresso",
      //                Qt::CaseInsensitive); ypos =
      //                ui->labelAnime00Titulo->y()+ui->labelAnime00Titulo->height()+2;
      //            }
      //            else if(this->findChild<QWidget
      //            *>(wid->objectName())->objectName().contains("nota",
      //            Qt::CaseInsensitive)){
      //                vposicaoGrade = vposicaoGrade.remove("nota",
      //                Qt::CaseInsensitive); ypos =
      //                static_cast<int>(ui->labelAnime00Titulo->y()+(ui->labelAnime00Titulo->height()*1.5)+4);
      //            }
      //            else if(this->findChild<QWidget
      //            *>(wid->objectName())->objectName().contains("lista",
      //            Qt::CaseInsensitive)){
      //                vposicaoGrade = vposicaoGrade.remove("lista",
      //                Qt::CaseInsensitive); ypos =
      //                ui->labelAnime00Titulo->y()+ui->labelAnime00Titulo->height()+
      //                        ((ui->labelAnime00Progresso->height())*2)+3;
      //            }
      //            else{
      //                ypos = ui->labelAnime00Titulo->y();
      ...
      //            if(vposicaoGrade.toInt()%3 == 0){
      //                this->findChild<QWidget
      //                *>(wid->objectName())->move(ui->labelAnime00Titulo->x(),
      //                    static_cast<int>(ypos+((2+ui->imagemAnime00->height())*
      //                        (vposicaoGrade.toInt()/3))));
      //            }
      //            else if((vposicaoGrade.toInt()-1)%3 == 0)
