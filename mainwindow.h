...
private:
  ...
  // Esses dois vetores não estão criando uma lista, mas recebendo uma lista
  // criada na classe leitorListaAnimes. A classe já está deletando todos os
  // ponteiros. Tentar deletar isso vai ser tentar deletar uma lista vaiza e
  // possivelemnte irá Crashar o programa
